...
// ✅ Static assets — 1 வருட cache (immutable)
app.use('/assets', (req, res, next) => {
  // Images, fonts, videos
  if (/\.(png|jpg|jpeg|gif|webp|svg|ico|mp4|webm|woff|woff2|ttf|otf)$/i.test(req.path)) {
    res.set('Cache-Control', 'public, max-age=31536000, immutable');
  }
  // CSS, JS — build hash மாறும்போது auto invalidate
...
// ✅ HTML — cache வேண்டாம் (always fresh)
app.use((req, res, next) => {
