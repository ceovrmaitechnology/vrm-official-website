                        ...
                        <div className="col-12">
                            <div className="big-bg-porduct-details">
                                <img
                                    ...
                                    alt="VRM AI Solutions Portfolio Details" loading="lazy" decoding="async"
                                />
                    ...
                    <div className="row g-5 mb--60">
                        <div className="col-lg-4">
                            <div className="thumbnail">
                                <img src="assets/images/product/d-01.jpg" alt="" loading="lazy" decoding="async" />
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="thumbnail">
                                <img src="assets/images/product/d-02.jpg" alt="" loading="lazy" decoding="async" />
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="thumbnail">
                                <img src="assets/images/product/d-03.jpg" alt="" loading="lazy" decoding="async" />
                            </div>
                        </div>
                    </div>
