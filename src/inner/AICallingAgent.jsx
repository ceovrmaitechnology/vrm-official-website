                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-5">
                            <div className="ai-agent-hero-img-container wow fadeInUp" data-wow-delay=".3s">
                                <img src="/assets/images/Solutions/AICallingAgent.png" alt="AI Calling Agent Dashboard" className="img-fluid" loading="lazy" decoding="async" />
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <SwiperSlide key={index}>
                                <div className="vrm-industry-slide-card bg-white">
                                    <div className="vrm-industry-slide-img-container">
                                        <img src={industry.img} alt={industry.title} loading="lazy" decoding="async" />
                                    </div>
