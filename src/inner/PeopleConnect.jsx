...
function PeopleConnect() {
    ...
    const images = [
        "/assets/images/people-connect/people-connect-image.png",
        "/assets/images/people-connect/people-connect-image-2.png",
        "/assets/images/people-connect/people-connect-image-3.png",
        "/assets/images/people-connect/people-connect-image-4.png"
    ];
        ...
        <div className="people-connect-page basic-font-family">
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-5">
                            <div className="banner-image-two wow fadeInUp" data-wow-delay=".3s">
                                <img src="/assets/images/people-connect/people-connect-image.png" alt="People Connect Citizen Engagement Dashboard" style={{ borderRadius: '20px', boxShadow: '0 20px 50px rgba(0,0,0,0.3)' }} loading="lazy" decoding="async" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-lg-10">
                            <div className="video-wrapper wow fadeInUp" data-wow-delay=".3s" style={{ borderRadius: '20px', overflow: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,0.15)' }}>
                                <video width="100%" controls preload="metadata">
                                    <source src="/assets/images/people-connect/people-connect-promo.mp4" type="video/mp4" />
                                ...
                                {images.map((img, index) => (
                                    <SwiperSlide key={index}>
                                        <div className="gallery-item wow fadeInUp" data-wow-delay={`.${index + 2}s`} style={{ borderRadius: '15px', overflow: 'hidden', boxShadow: '0 10px 30px rgba(0,0,0,0.08)', border: '1px solid #eee' }}>
                                            <img src={img} alt={`People Connect Interface Dashboard ${index + 1}`} style={{ width: '100%', height: 'auto', display: 'block' }} loading="lazy" decoding="async" />
                                        </div>
                                    </SwiperSlide>
                                ))}
                            </Swiper>
            ...
            <div className="vrm-full-width-section vrm-white-bg">
                <div className="container">
                    ...
                    <div className="row mt--50 g-4">
                        {[
                            { title: "AI Voice Outreach", icon: "fal fa-phone-volume" },
                            { title: "WhatsApp Citizen Platform", icon: "fab fa-whatsapp" },
                            { title: "Geographic Intelligence", icon: "fal fa-map-marked" },
                            { title: "Decision Analytics", icon: "fal fa-chart-pie" }
                        ].map((offer, idx) => (
                            <div key={idx} className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay={`.${(idx + 1) * 2}s`}>
