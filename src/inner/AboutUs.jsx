                ...
                <div className="container">
                    ...
                    <div className="row g-4">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="service-card-about">
                                <div className="service-thumb">
                                    <img src="/assets/images/Solutions/AICallingAgent.png" alt="AI Calling Agent" loading="lazy" decoding="async" />
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="service-card-about">
                                <div className="service-thumb">
                                    <img src="/assets/images/Solutions/AIConsultingService.png" alt="AI Consulting" loading="lazy" decoding="async" />
                                </div>
                                <div className="service-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="service-card-about">
                                <div className="service-thumb">
                                    <img src="/assets/images/Solutions/AIDevelopment.png" alt="AI Development" loading="lazy" decoding="async" />
                                </div>
                                <div className="service-content">
                    ...
                    <div className="row align-items-stretch g-5">
                        ...
                        <div className="col-lg-6 d-flex align-items-center justify-content-center mt-4 mt-lg-0">
                            <div className="thumbnail position-relative" style={{ maxWidth: '400px', width: '100%', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,0,0,0.15)' }}>
                                <img src="/assets/images/faq/02.png" alt="Why Choose Us" style={{ width: '100%', height: 'auto', objectFit: 'cover', display: 'block' }} loading="lazy" decoding="async" />
                            </div>
                        </div>
                    </div>
                </div>
