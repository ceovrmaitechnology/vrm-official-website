                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-5">
                            <div className="banner-image-two wow fadeInUp" data-wow-delay=".3s">
                                <img src="/assets/images/workflow/screensage/screensage-image.png" alt="ScreenSage AI Dashboard" style={{ borderRadius: '20px', boxShadow: '0 20px 50px rgba(0,0,0,0.3)' }} loading="lazy" decoding="async" />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                {images.map((img, index) => (
                                    <SwiperSlide key={index}>
                                        <div className="gallery-item wow fadeInUp" data-wow-delay={`.${index + 2}s`} style={{ borderRadius: '15px', overflow: 'hidden', boxShadow: '0 10px 30px rgba(0,0,0,0.08)', border: '1px solid #eee' }}>
                                            <img src={img} alt={`ScreenSage Interface ${index + 1}`} style={{ width: '100%', height: 'auto', display: 'block' }} loading="lazy" decoding="async" />
                                        </div>
                                    </SwiperSlide>
                                ))}
                            </Swiper>
