                    ...
                    <div className="row">
                        <div className="col-xl-8 col-md-12 col-sm-12 col-12">
                            ...
                            <div className="service-detials-step-1">
                                <div className="thumbnail">
                                    <img src="assets/images/service/01.jpg" alt="business-area"  loading="lazy" />
                                </div>
                                ...
                                <div className="row g-5 align-items-center">
                                    <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div className="thumbnail sm-thumb-service">
                                            <img src="assets/images/service/sm-01.jpg" alt="Service"  loading="lazy" />
                                        </div>
                                    </div>
                        ...
                        <div className="col-xl-4 col-md-12 col-sm-12 col-12 mt_lg--60 pl--50 pl_md--0 pl-lg-controler pl_sm--0">
                            ...
                            <div className="rts-single-wized contact service">
                                <div className="wized-header">
                                    <Link to={'#'}>
                                        <img src="assets/images/logo/logo.jpeg" alt="Business_logo"  loading="lazy" />
                                    </Link>
                                </div>
                                <div className="wized-body">
