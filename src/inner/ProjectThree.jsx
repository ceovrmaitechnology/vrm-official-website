                ...
                <div className="container">
                    <div className="grid row align-items-center">
                        <div className="col-lg-4 col-md-6 col-sm-12 grid-item cat3">
                            <div className="portfolio-wrapper2 mb-30">
                                <div className="img-fluid">
                                    <img src="assets/images/product/01.jpg" alt="Portfolio Img" loading="lazy" decoding="async" />
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 grid-item cat1">
                            <div className="portfolio-wrapper2 mb-30">
                                <div className="img-fluid">
                                    <img src="assets/images/product/02.jpg" alt="Portfolio Img" loading="lazy" decoding="async" />
                                    <div className="portfolio-content">
                                        <Link className="fw-bold text-white" to={'/project-details'}>
                                            Veiw Details{" "}
                                        </Link>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 grid-item cat2">
                            <div className="portfolio-wrapper2 mb-30">
                                <div className="img-fluid">
                                    <img src="assets/images/product/03.jpg" alt="Portfolio Img" loading="lazy" decoding="async" />
                                    <div className="portfolio-content">
                                        <Link className="fw-bold text-white" to={'/project-details'}>
                                            Veiw Details{" "}
                                        </Link>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 grid-item cat1">
                            <div className="portfolio-wrapper2 mb-30">
                                <div className="img-fluid">
                                    <img src="assets/images/product/04.jpg" alt="Portfolio Img" loading="lazy" decoding="async" />
                                    <div className="portfolio-content">
                                        <Link className="fw-bold text-white" to={'/project-details'}>
                                            Veiw Details{" "}
                                        </Link>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 grid-item cat4">
                            <div className="portfolio-wrapper2 mb-30">
                                <div className="img-fluid">
                                    <img src="assets/images/product/05.jpg" alt="Portfolio Img" loading="lazy" decoding="async" />
                                    <div className="portfolio-content">
                                        <Link className="fw-bold text-white" to={'/project-details'}>
                                            Veiw Details{" "}
                                        </Link>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 grid-item cat2">
                            <div className="portfolio-wrapper2 mb-30">
                                <div className="img-fluid">
                                    <img src="assets/images/product/06.jpg" alt="Portfolio Img" loading="lazy" decoding="async" />
                                    <div className="portfolio-content">
                                        <Link className="fw-bold text-white" to={'/project-details'}>
                                            Veiw Details{" "}
                                        </Link>
