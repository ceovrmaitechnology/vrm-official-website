                    ...
                    <div className="row g-5 align-items-center">
                        <div className="col-lg-6">
                            <div className="image-area">
                                <img src="assets/images/service/h2/03.jpg" alt="Service_Image" loading="lazy" decoding="async" />
                                <img
                                    className="two"
                                    src="assets/images/service/h2/02.jpg"
                                    alt="Service_Image" loading="lazy" decoding="async"
                                />
                                <img
                                    className="three"
                                    ...
                                    <div className="support-team">
                                        <Link to={'/team-details'} className="thumbnail">
                                            <img
                                                ...
                                                alt="Image-team" loading="lazy" decoding="async"
                                            />
                                        </Link>
