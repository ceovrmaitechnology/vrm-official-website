                        ...
                        <div className="col-lg-6 col-md-12">
                            ...
                            <div className="rts-business-solution-left">
                                <div className="thumbnail">
                                    <img src="assets/images/business-goal/03.jpg" alt="" loading="lazy" decoding="async" />
                                    ...
                                    <div className="shape3">
                                        <img src="assets/images/business-goal/icon/bag.png" alt="" loading="lazy" decoding="async" />
                                    </div>
                                </div>
                            </div>
