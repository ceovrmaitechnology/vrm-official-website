                        ...
                        <div className="swiper">
                            ...
                            >
                                <SwiperSlide>
                                    ...
                                    <div className="team-inner-two">
                                        <Link to={'/team-details'} className="thumbnail">
                                            <img src="assets/images/team/tm/lg-01.jpg" alt="" loading="lazy" decoding="async" />
                                        </Link>
                                        {/* Acquaintance area */}
                                ...
                                <SwiperSlide>
                                    ...
                                    <div className="team-inner-two">
                                        <Link to={'/team-details'} className="thumbnail">
                                            <img src="assets/images/team/tm/lg-02.jpg" alt="" loading="lazy" decoding="async" />
                                        </Link>
                                        {/* Acquaintance area */}
                                        <div className="acquaintance-area">
                                            <div className="header">
                                ...
                                <SwiperSlide>
                                    ...
                                    <div className="team-inner-two">
                                        <Link to={'/team-details'} className="thumbnail">
                                            <img src="assets/images/team/tm/lg-03.jpg" alt="" loading="lazy" decoding="async" />
                                        </Link>
                                        {/* Acquaintance area */}
                                        <div className="acquaintance-area">
                                            <div className="header">
