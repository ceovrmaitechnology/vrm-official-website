                ...
                <div className="container">
                    ...
                    <div className="row g-5 mt--30">
                        <div className="col-lg-6">
                            ...
                            <div className="single-blog-style-ten">
                                <Link to="/blog/26" className="thumbnail">
                                    <img src="assets/images/blog/17.png" alt="blog" loading="lazy" decoding="async" />
                                </Link>
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="single-blog-style-ten">
                                <Link to="/blog/26" className="thumbnail">
                                    <img src="assets/images/blog/18.png" alt="blog" loading="lazy" decoding="async" />
                                </Link>
                                <div className="information">
                                    <div className="blog-top-area">
                                        <div className="single-area">
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="single-blog-style-ten">
                                <Link to="/blog/26" className="thumbnail">
                                    <img src="assets/images/blog/19.png" alt="blog" loading="lazy" decoding="async" />
                                </Link>
                                <div className="information">
                                    <div className="blog-top-area">
                                        <div className="single-area">
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="single-blog-style-ten">
                                <Link to="/blog/26" className="thumbnail">
                                    <img src="assets/images/blog/20.png" alt="blog" loading="lazy" decoding="async" />
                                </Link>
                                <div className="information">
                                    <div className="blog-top-area">
                                        <div className="single-area">
