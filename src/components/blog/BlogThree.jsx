                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="blog-three-wrapepr">
                                <Link to={'/blog/1'} className="main-thumbnail">
                                    <img src="assets/images/blog/05.jpg" alt="Blog_image" loading="lazy" decoding="async" />
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="blog-three-wrapepr">
                                <Link to={'/blog/2'} className="main-thumbnail">
                                    <img src="assets/images/blog/06.jpg" alt="Blog_image" loading="lazy" decoding="async" />
                                    <span className="badge-blog">Solution</span>
                                </Link>
                                <div className="blog-body">
                                    <div className="blog-header">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="blog-three-wrapepr">
                                <Link to={'/blog/3'} className="main-thumbnail">
                                    <img src="assets/images/blog/07.jpg" alt="Blog_image" loading="lazy" decoding="async" />
                                    <span className="badge-blog">Solution</span>
                                </Link>
                                <div className="blog-body">
                                    <div className="blog-header">
