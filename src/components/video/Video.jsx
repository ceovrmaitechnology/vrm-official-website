        ...
        <div>
            ...
            <div className="rts-vedio-area-home-6 rts-section-gapBottom">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="thumbnail-image-gallery">
                                <img src="assets/images/gallery/01.jpg" alt="thumbnail-image" loading="lazy" decoding="async" />
                ...
                <div className="bg-shape-vedio-section">
                    <img src="assets/images/gallery/bg-vedio.png" alt="bg" loading="lazy" decoding="async" />
                </div>
            </div>
