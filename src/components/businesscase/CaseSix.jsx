    ...
    return (
        <div>
            ...
            <div className="business-progress-area rts-section-gapBottom">
                <div className="box">
                    <img src="assets/images/business-goal/icon/box.png" alt="box" loading="lazy" decoding="async" />
                </div>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="thumbnail-progress-7">
                                <img src="assets/images/business-goal/05.png" alt="progress" loading="lazy" decoding="async" />
                            </div>
                        </div>
                        <div className="col-lg-6">
                            ...
                            <div className="inner-goal-progress-7">
                                ...
                                <Link to={'#'} className="rts-btn btn-primary-5">
                                    Let’s Work Together
                                </Link>
                            </div>
                        </div>
