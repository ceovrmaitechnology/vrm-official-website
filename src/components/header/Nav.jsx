...
export default function Nav() {
    ...
    // Reset content when leaving the list or changing major tabs
    const handleMouseLeave = () => {
        // Logic to reset to default based on context could go here if needed,
        // but keeping the last hovered item is often a better UX.
        // Or reset to default of the active tab.
        if (activeSubMenu === 'workflow') setFeaturedContent(defaultWorkflowContent);
        else if (activeSubMenu === 'growthflow') setFeaturedContent(defaultGrowthFlowContent);
        else setFeaturedContent(defaultSolutionsContent);
    };
