                    ...
                    <div className="row g-5">
                        <div className="col-lg-5">
                            <div className="about-three-thumbnail-left">
                                <img src="assets/images/about/main/05.jpg" alt="Business-about" loading="lazy" decoding="async" />
                                <div className="about-sm-thumb">
                                    <img
                                        src="assets/images/about/main/about-01-sm.jpg"
                                        alt="business_about-sm" loading="lazy" decoding="async"
                                    />
                                </div>
                                <a href="/" className="vedio-icone">
                                    <span id="play-video" className="video-play-button" onClick={openVideo}>
                                        <img
                                            ...
                                            alt="Play btn" loading="lazy" decoding="async"
                                        />
                                        <span />
                                    </span>
                                    {isVideoOpen && (
                                            ...
                                            <div className="user-wrapper">
                                                <a href="/">
                                                    <img
                                                        ...
                                                        alt="Business_User" loading="lazy" decoding="async"
                                                    />
                                                </a>
                                                <a href="/">
                                                    <img
