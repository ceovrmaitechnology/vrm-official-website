                    ...
                    <div className="row g-5 mt--10">
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            ...
                            <div className="single-service-home-six">
                                <div className="icon">
                                    <img src="assets/images/service/icon/19.svg" alt=""  loading="lazy" />
                                </div>
                                <div className="inner">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            ...
                            <div className="single-service-home-six">
                                <div className="icon">
                                    <img src="assets/images/service/icon/20.svg" alt=""  loading="lazy" />
                                </div>
                                <div className="inner">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            ...
                            <div className="single-service-home-six">
                                <div className="icon">
                                    <img src="assets/images/service/icon/21.svg" alt=""  loading="lazy" />
                                </div>
                                <div className="inner">
