                        ...
                        <div key={product.id} className="vrm-product-card wow fadeInUp" data-wow-delay=".3s">
                            <div className="vrm-product-card-bg">
                                <img 
                                    ...
                                    width="346" 
                                    height="346" loading="lazy" decoding="async" 
                                />
                            </div>
                            <div className="vrm-product-card__content">
                                <div className="vrm-hero__icon">
                                    <img src={product.icon} alt={product.title} loading="lazy" decoding="async" />
                                </div>
                                <h3>{product.title}</h3>
                                <p>{product.desc}</p>
                            ...
                            <div key={product.id} className="vrm-product-card wow fadeInUp" data-wow-delay=".3s">
                                <div className="vrm-product-card-bg">
                                    <img 
                                        src={product.bgImage} 
                                        alt="" 
                                        style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", objectFit: "cover" }} loading="lazy" decoding="async" 
                                    />
                                </div>
                                <div className="vrm-product-card__content">
                                    <div className="vrm-hero__icon">
